...
def main():
    ...
    plot = px.bar(remaining_prize_data, x="name_price", y='prize_remaining_num', text='prize_amount',hover_data=['prize_start_num', 'prize_remaining_num', 'prize_probability'], color='prize_amount')
